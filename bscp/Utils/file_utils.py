...
class FileUtils:
    ...
    @staticmethod
    def save_json(data: Any, path: str, file_name: str) -> None:
    ...
    @staticmethod
    def load_json(path: str, file_name: str) -> Any:
        full_path = Path(path) / f"{file_name}.json"
    ...
    @staticmethod
    def save_binary(data: Any, path: str, file_name: str) -> None:
        FileUtils.ensure_dir(path)
    ...
    @staticmethod
    def load_binary(path: str, file_name: str) -> Any:
        full_path = Path(path) / f"{file_name}.bin"
        if not full_path.exists(): raise FileNotFoundError(f"File not found: {full_path}")
    ...
    @staticmethod
    def exists(path: str, file_name: str, extension: str) -> bool:
        return (Path(path) / f"{file_name}.{extension}").exists()

    @staticmethod
    def delete(path: str, file_name: str, extension: str) -> None:
